...
Source: "{#AppServerConfigDir}\*"; DestDir: "{app}\scripts"; Flags: ignoreversion; Components: apache;
...
Filename: "{tmp}\updateServerConfigForFedora.bat"; Parameters: "{#TomcatDir} {#fedora_server} {#fedora_port} {#fedora_user} {#fedora_password} {#FedoraDir}";
Filename: "{tmp}\updateServerConfigXslt.bat"; Parameters: "{#TomcatDir}";
